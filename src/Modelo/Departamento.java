 ...
 * en sql de la tabla departamento
 *
 * @author Carlos Baez
 */
public class Departamento {
    ...
    /**
     * Obtiene una tabla modelo con todos los departamentos registradas en el
     * sistema
     *
     ...
     *
     * @param departamento identificador unico del departamento (tamaño 2)
     * @return devuelve todos los campos del departamento, para que sean
     * asigandos de nuevo a los campos en la vista
     */
    ...
    /**
     * Perimite obtener todos los elementos en la tabla departamento
     */
