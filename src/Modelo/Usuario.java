...
/**
 * Esta clase define los metodos necesarios para realizar las operacions basicas
 * en sql de la tabla usuarios
 *
 * @author Carlos Baez
 */
public class Usuario {
     ...
     */
    public void insertaEditarUsuario(int cedula, String nombres, String apellidos,
            String direccion, String telefono, Date fechaNacimiento,
            String experienciaLaboral, String nivelAcademico, String ciudad, boolean opcion) {
        if (opcion == true) {
     ...
     *
     * @return debe ser asignada a la tabla encargada de mostrar todas los
     * usuarios
     */
     ...
     * @return devuelve todos los campos del usuario, para que sean asigandos de
     * nuevo a los campos en la vista
     */
